...
public class L16Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time1 = findViewById(R.id.audioTime15_1);
        time2 = findViewById(R.id.audioTime15_2);
        seekBar = findViewById(R.id.seekbar15);
        mbPlay = findViewById(R.id.btnPlay15);
        mbPause = findViewById(R.id.btnPause15);
        mediaPlayer = MediaPlayer.create(this, R.raw.audio1_6);
