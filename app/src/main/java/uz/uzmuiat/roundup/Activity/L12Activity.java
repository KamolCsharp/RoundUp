...
public class L12Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time1 = findViewById(R.id.audioTime11_1);
        time2 = findViewById(R.id.audioTime11_2);
        seekBar = findViewById(R.id.seekbar11);
        mbPlay = findViewById(R.id.btnPlay11);
        mbPause = findViewById(R.id.btnPause11);
        mediaPlayer = MediaPlayer.create(this, R.raw.audio1_2);
