...
public class L13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time1 = findViewById(R.id.audioTime12_1);
        time2 = findViewById(R.id.audioTime12_2);
        seekBar = findViewById(R.id.seekbar12);
        mbPlay = findViewById(R.id.btnPlay12);
        mbPause = findViewById(R.id.btnPause12);
        mediaPlayer = MediaPlayer.create(this, R.raw.audio1_3);
