...
public class L15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time1 = findViewById(R.id.audioTime14_1);
        time2 = findViewById(R.id.audioTime14_2);
        seekBar = findViewById(R.id.seekbar14);
        mbPlay = findViewById(R.id.btnPlay14);
        mbPause = findViewById(R.id.btnPause14);
        mediaPlayer = MediaPlayer.create(this, R.raw.audio1_5);
