...
public class L17Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time1 = findViewById(R.id.audioTime16_1);
        time2 = findViewById(R.id.audioTime16_2);
        seekBar = findViewById(R.id.seekbar16);
        mbPlay = findViewById(R.id.btnPlay16);
        mbPause = findViewById(R.id.btnPause16);
        mediaPlayer = MediaPlayer.create(this, R.raw.audio1_7);
